...
import LayoutComponent from "./CustomFontSizeComp";
...
export default class FontSize extends Component {
  ...
  componentWillReceiveProps(properties) {
    if (
      ...
      this.setState({
        currentFontSize: getSelectionCustomInlineStyle(properties.editorState, [
          "FONTSIZE"
        ]).FONTSIZE
      });
    }
  ...
  render() {
    ...
    const FontSizeComponent = LayoutComponent;
